...
return [
    ...
    'GAME_HOST' => 'http://test.h5.game-232.dev',//游戏客户端地址
    'GAME_HOST_PC' => 'http://test.pc.game-232.conf/game.php',//游戏PC端地址+
    'TEST_USER_COUNT' => 10, //测试联调账号只能有是个玩家
    'GET_EXCEPTION_ORDER_LIST_MAX'    => 1000,//限定每次获取异常注单数据最大记录的条数
];
